...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_beta.setPixmap(QtGui.QPixmap(_fromUtf8("../../../images/icon_params_beta.png")))
        ...
        self.label_alpha.setPixmap(QtGui.QPixmap(_fromUtf8("../../../images/icon_params_alpha.png")))
